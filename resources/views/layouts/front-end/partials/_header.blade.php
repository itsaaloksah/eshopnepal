        ...
        <div class="container">
            ...
            <div>
                <div class="topbar-text dropdown d-md-none {{Session::get('direction') === "rtl" ? 'mr-auto' : 'ml-auto'}}">
                    <a class="topbar-link" href="mailto: {{$web_config['email']->value}}">
                        <i class="fa fa-envelope m-2"></i> {{$web_config['email']->value}}
                    </a>
                </div>
                <div class="d-none d-md-block {{Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'}} text-nowrap">
                    <a class="topbar-link d-none d-md-inline-block" href="mailto:{{$web_config['email']->value}}">
                        <i class="fa fa-envelope m-2"></i> {{$web_config['email']->value}}
                    </a>
                </div>
            </div>
